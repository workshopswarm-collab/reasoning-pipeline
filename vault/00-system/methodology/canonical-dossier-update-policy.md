...
Canonical dossiers in `vault/20-entities/` and major overview notes in `vault/10-domains/` are **slow-moving summaries**, not raw research logs.
...
- `vault/40-research/source-notes/`
- `vault/40-research/agent-findings/`
- `vault/40-research/syntheses/`
- `vault/40-research/investigations/`
