...
owner: orchestrator
tags: [drivers/guide, vault/30-drivers, workflow]
---
...
Keep these in `vault/40-research/` instead:
- one-off events
- source extracts
...
Keep these in `vault/50-retrospectives/` instead:
...
1. Read `vault/30-drivers/README.md`.
...
Default structure:
- use **flat driver files** directly under `vault/30-drivers/`
