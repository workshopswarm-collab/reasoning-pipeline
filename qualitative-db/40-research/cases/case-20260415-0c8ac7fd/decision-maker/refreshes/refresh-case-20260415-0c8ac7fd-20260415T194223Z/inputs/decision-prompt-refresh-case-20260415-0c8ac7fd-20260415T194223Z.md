...
```json
{"recommended_mode":"light","reasons":["material_price_move"],"current_price":0.895,"last_reasoned_price":0.845,"price_delta_pct_points":5.0,"hours_since_last_forecast":0.41,"hours_to_close":44.29,"latest_forecast":{"forecast_id":"dispatch-case-20260415-0c8ac7fd-20260415T190844Z","forecast_prob":0.845,"decision_ts":"2026-04-15T15:18:00-04:00","rationale_summary":"BTC is more likely than not by a wide margin to finish above $72,000 on the April 17 Binance noon minute, but with fair value centered near 0.845 versus a 0.87 market and meaningful exact-minute downside tail still live, …"},"snapshot_summary":{"snapshot_count":12,"min_reference_price":0.89,"max_reference_price":0.895,"avg_reference_price":0.8904166666666666},"live_market_probe":{"closed":false,"archived":false,"acceptingOrders":true,"umaResolutionStatus":"","outcomePrices":["0.91","0.09"]},"focused_questions":["Did the market move invalidate the prior crux, or is this mainly repricing without new information?","Does the new price imply the previous edge has materially compressed or inverted?","Has time-to-close changed the appropriate confidence or action threshold?","Can we update priors responsibly using prior synthesis plus current market state without rerunning the full swarm?"]}
```
