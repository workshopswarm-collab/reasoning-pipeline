...
1. **Primary governing source / direct resolution mechanics**
   ...
   - Existing case note: `source-notes/2026-04-05-base-rate-polymarket-rules.md`
...
2. **Primary factual source for possible qualifying impact**
   ...
   - New note: `source-notes/2026-04-05-risk-manager-bbc-uae-direct-impacts.md`
...
3. **Key secondary / attribution source**
   ...
   - New note: `source-notes/2026-04-05-risk-manager-uae-official-attribution-and-window.md`
