...
source_url: https://www.boxofficemojo.com/
source_date: 2026
...
upstream_inputs: []
downstream_uses: [qualitative-db/10-domains/culture/film/00-overview.md]
tags: [domain/culture, subdomain/film, source/box-office-metrics]---

# Summary

Box Office Mojo is a useful base source for film-release scheduling and commercial timing context, which are key inputs for many culture-market questions.

## Key facts extracted

- Release schedule timing is visible and changes over time.
- Distribution mode (wide vs limited) matters.
- Release-date changes are themselves meaningful signals.
...
Good baseline film-release and commercial timing source; later pair with critical reception and streaming data.
