...
source_url: https://en.wikipedia.org/wiki/XRP
source_date:
...
upstream_inputs: []
downstream_uses: [qualitative-db/20-entities/protocols/xrp.md]
tags: [domain/crypto, entity/xrp, source/protocol-overview]---

# Summary

XRPL is a payments- and settlement-oriented crypto network whose token, XRP, is tightly linked to legal framing and cross-border transfer narratives.
...
Good baseline framing; should later be paired with first-party XRPL docs and neutral market-data sources.
