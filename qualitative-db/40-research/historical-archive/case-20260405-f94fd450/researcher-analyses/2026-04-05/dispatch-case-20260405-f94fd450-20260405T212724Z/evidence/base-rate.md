...
- **Polymarket rules note** (`researcher-source-notes/2026-04-05-base-rate-polymarket-rules.md`)
...
- **BBC impact reporting** (`researcher-source-notes/2026-04-05-base-rate-bbc-uae-impacts.md`)
  ...
  - Weight: very high.
- **Khaleej Times / The National series** (`researcher-source-notes/2026-04-05-base-rate-uae-reporting-march-series.md`)
