...
2. `qualitative-db/00-system/START-HERE.md` ← this file
3. `qualitative-db/00-system/README.md`
4. then only the layer READMEs relevant to your task

Read these next only if needed:
- editing canonical entity notes -> `qualitative-db/00-system/governance/canonical-entity-policy.md`
- editing `related_entities` / `related_drivers` -> `qualitative-db/00-system/governance/entity-linkage-framework.md`
- creating or pruning a domain subfolder / subdomain overview -> `qualitative-db/00-system/governance/subdomain-overview-policy.md`
- deciding whether research should be promoted into canon -> `qualitative-db/00-system/methodology/canonical-memory-workflow.md`
- writing a new note -> `qualitative-db/00-system/templates/README.md` and the matching template
...
- **Researchers** -> may read any vault document, but normally edit only `qualitative-db/40-research/`
...
- working in `10-domains/` -> read `qualitative-db/10-domains/README.md`
