...
tags: [system/policy, memory/canonical, qualitative-db/governance]
---

# Canonical Entity Policy

This policy governs what belongs in `qualitative-db/20-entities/` versus `qualitative-db/40-research/`.
...
Within `qualitative-db/20-entities/`:
...
- `qualitative-db/60-uncategorized/archive/merged-duplicates/`
- `qualitative-db/60-uncategorized/archive/low-signal-media/`
