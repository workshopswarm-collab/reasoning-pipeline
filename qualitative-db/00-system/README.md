...
If a lower-level README conflicts with `qualitative-db/00-system/`, follow `qualitative-db/00-system/`.
...
- research notes in `qualitative-db/40-research/` are not dossiers
